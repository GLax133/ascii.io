...
(function() {
  ...
  AsciiIo.Models.Comment = (function(_super) {
  ...
  AsciiIo.Collections.Comments = (function(_super) {
    ...
    Comments.prototype.model = AsciiIo.Models.Comment;
...
(function() {
  ...
  AsciiIo.Views.Base = (function(_super) {
    ...
    Base.prototype.current_user = function() {
      return AsciiIo.current_user;
    };
...
(function() {
  ...
  AsciiIo.Views.CommentsIndex = (function(_super) {
    ...
    CommentsIndex.prototype.initialize = function() {
      ...
      return $('#new-comment').submit(function(event) {
        return _this.createComment(event);
      });
    };

    CommentsIndex.prototype.addAll = function() {
      var _this = this;
      return this.collection.each(function(comment) {
        return _this.addOne(comment);
      });
    };

    CommentsIndex.prototype.addOne = function(comment) {
      var view;
      view = new AsciiIo.Views.CommentEntry({
        model: comment,
    ...
    CommentsIndex.prototype.createComment = function(event) {
      var attrs;
      event.preventDefault();
      attrs = {
